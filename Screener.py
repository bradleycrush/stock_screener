...
for stock in stock_list[0:len(si.tickers_nasdaq())]:
    n += 1
    ...
    try:
        ...
        if condition_1 and condition_2 and condition_3 and condition_4 \
            ...
            if currentClose > low_of_52week:
                percent_over_52_week_low = low_of_52week / currentClose

            exportList = exportList.append({'Stock Rating': stock, "RS Rating": RS_Rating,
